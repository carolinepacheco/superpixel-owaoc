%SelectRandomSubspace Trainable random subspace combining classifier
%
%    featset = SelectRandomSubspace(A,NFEAT,NCLASSF)
%    featset = A*SelectRandomSubspace([],NFEAT,NCLASSF)
%    featset = A*SelectRandomSubspace(NFEAT,NCLASSF)
%
% INPUT
%   A       Dataset
...
function featset = SelectRandomSubspace(varargin)
