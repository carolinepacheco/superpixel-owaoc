...
% vector something. It can be:
%    ITYPE
%    'svc'    support vector classifier
%    'svdd'   support vector data description
%
% SEE ALSO
% incsvdd, incsvc, inc_add, inc_store
function W = inc_setup(itype,ktype,kpar,C,x,y,dw)
...
% end
 ...
 try
    ...
    if strcmp(ME.identifier,'inc:InfeasibleSolution') || ...
            strcmp(ME.identifier,'dd_tools:change_R:DivideByZero')
           try
       W = inc_add(W,x(i+1,:),y(i+1,:), dw(i+1,:));
           end
      %  x(i,:) = 1;
