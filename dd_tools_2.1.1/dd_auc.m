% DD_AUC integrated error under the ROC curve
%
%   PERF = DD_AUC(R,BND)
%   PERF = DD_AUC(A*W,BND)
%   PERF = A*W*DD_AUC([],BND)
...
%
% OUTPUT
%   PERF   Area under the ROC curve
%
% DESCRIPTION
% Compute the integrated error under the ROC curve, given in R (as
% obtained by dd_roc).
...
if (nargin<1) || isempty(e)
   err = prmapping(mfilename,'fixed',bnd);
